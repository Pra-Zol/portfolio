      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="contact-subtitle">
            I'm currently open to <strong>junior developer</strong> roles and internships.
        ...
        <div className={`contact-grid ${inView ? 'visible' : ''}`}>
          ...
          <div className="contact-info">
            ...
            <p className="contact-info-desc">
              I'm passionate about building meaningful software and would love to discuss
              how I can contribute to your team. Feel free to reach out through any channel below.
            </p>
                  ...
                  <div className="contact-item-body">
                    ...
                    {item.href ? (
                      <a href={item.href} target="_blank" rel="noopener noreferrer"
                        className="contact-item-value link">{item.value}</a>
                    ) : (
            ...
            <form className="contact-form" onSubmit={handleSubmit} noValidate>
              ...
              {status === 'error' && (
                <div className="form-status error">
                  <FiAlertCircle /> Something went wrong. Please try emailing directly.
                </div>
              )}
